...
{
    public class NeuralNetwork<T> where T : IComparable<T>
    {
        private IBackPropagationNet<T> NeuralNet;
        ...
        public NeuralNetwork(IBackPropagationNet<T> IBackPro, Dictionary<T, double[]> trainingSet)
        {
            NeuralNet = IBackPro;
        ...
        public bool Train()
        {
            ...
            do
            {
                ...
                {
                    IterationChanged?.Invoke(this, new NeuralEventArgs
                    {
        ...
        public void LoadNetwork(string path)
        {
            ...
            BinaryFormatter BF = new BinaryFormatter();
            NeuralNet = (IBackPropagationNet<T>)BF.Deserialize(FS);
            FS.Close();
        }
    }
}
